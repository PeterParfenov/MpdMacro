...
const Int_t marker_res_style[]={24,20};
...
const Int_t marker_res_color[]={601,1,2,4};
const Int_t marker_res_color_selection[]={601,1,2,6};
const Int_t marker_eff_color[]={4,8};
const Int_t line_pt_style[]   ={1,2,9};

const Float_t latex_coord[]     ={0.23,0.88};
const TString latex_title[2][2] ={{TString("Au+Au, UrQMD, #sqrt{s_{NN}}=5 GeV, 10-20%") , TString("Au+Au, UrQMD, #sqrt{s_{NN}}=5 GeV, 40-50%") },
                                  {TString("Au+Au, UrQMD, #sqrt{s_{NN}}=11 GeV, 10-20%"), TString("Au+Au, UrQMD, #sqrt{s_{NN}}=11 GeV, 40-50%")}};

const Float_t range_vn_pt[2][2]      ={{-0.15,0.159},{-0.,0.129}};
...
const Float_t vn_cent_range[2][2]    ={{-0.09,0.01},{-0.004,0.045}};
...
const TString energy_title[]={TString("5 GeV"),TString("11 GeV")};
...
void Draw_TDR()
{
    ...
    TFile* inTrSel[n_energy];

    TFile* in_res_laqgsm_file = new TFile("/home/peter/Documents/WorkLocal/MPD/RootFiles/TDR/LAQGSM.root","read");
    TFile* in_res_true_laqgsm_file = new TFile("/home/peter/Documents/WorkLocal/MPD/RootFiles/TDR/res_hist-11gev-LAQGSM-GEANT3.root","read");
    TFile* in_res_reco_laqgsm_file = new TFile("/home/peter/Documents/WorkLocal/MPD/RootFiles/TDR/res-fit-11gev-LAQGSM-GEANT3.root","read");
    ...
    in_res_true_file[0] = new TFile("/home/peter/Documents/WorkLocal/MPD/RootFiles/TDR/res_hist-5gev-4MPDG.root","read");
    //in_res_true_file_HP[0] = new TFile("/home/peter/Documents/WorkLocal/MPD/RootFiles/TDR/res-5-gev_HP.root","read");
    in_res_reco_file[0] = new TFile("/home/peter/Documents/WorkLocal/MPD/RootFiles/TDR/res-fit-5gev-4MPDG.root","read");
    in_res_true_file[1] = new TFile("/home/peter/Documents/WorkLocal/MPD/RootFiles/TDR/res_hist-11gev-4MPDG.root","read");
    //in_res_true_file_HP[1] = new TFile("/home/peter/Documents/WorkLocal/MPD/RootFiles/TDR/res-11-gev_HP.root","read");
    in_res_reco_file[1] = new TFile("/home/peter/Documents/WorkLocal/MPD/RootFiles/TDR/res-fit-11gev-4MPDG.root","read");

    in_flow_file[0][0] = new TFile("/home/peter/Documents/WorkLocal/MPD/RootFiles/TDR/flow-5gev-protons4M.root","read");
    in_flow_file[0][1] = new TFile("/home/peter/Documents/WorkLocal/MPD/RootFiles/TDR/flow-5gev-kaons4M.root","read");
    in_flow_file[0][2] = new TFile("/home/peter/Documents/WorkLocal/MPD/RootFiles/TDR/flow-5gev-pions4M.root","read");
    in_flow_file[1][0] = new TFile("/home/peter/Documents/WorkLocal/MPD/RootFiles/TDR/flow-11gev-protons4M.root","read");
    in_flow_file[1][1] = new TFile("/home/peter/Documents/WorkLocal/MPD/RootFiles/TDR/flow-11gev-kaons4M.root","read");
    in_flow_file[1][2] = new TFile("/home/peter/Documents/WorkLocal/MPD/RootFiles/TDR/flow-11gev-pions4M.root","read");
    
    inTrSel[0]         = new TFile("/home/peter/Documents/WorkLocal/MPD/RootFiles/TDR/qa_pid_5gev.root","read");
    inTrSel[1]         = new TFile("/home/peter/Documents/WorkLocal/MPD/RootFiles/TDR/qa_pid_5gev.root","read");
    ...
    for (Int_t i_harm=0; i_harm<n_harm; i_harm++){
        p_res_laqgsm_vs_centrality[i_harm] = (TH1F*) in_res_reco_laqgsm_file->Get(Form("p_ResPsi_vs_b[%i][%i][%i]",i_harm,0,1));
        p_res_laqgsm_vs_centrality[i_harm]->SetName(Form("p_res_laqgsm_vs_centrality%i",i_harm));
        h_res_laqgsm_vs_centrality[i_harm] = (TH1F*) in_res_true_laqgsm_file->Get(Form("p_true_Res_vs_b[%i][%i][%i]",i_harm,0,1));
    ...
    for (Int_t i_energy=0;i_energy<n_energy;i_energy++){
        h_n_hits_before[i_energy] = (TH1F*) inTrSel[i_energy]->Get(Form("Selection/hCutHitsBefore"));
        h_n_hits_before[i_energy]->SetName(Form("h_n_hits_before%i",i_energy));
        h_n_hits_after[i_energy] = (TH1F*) inTrSel[i_energy]->Get(Form("Selection/hCutHitsAfter"));
    ...
    for (Int_t i_energy=0;i_energy<n_energy;i_energy++){
        ...
        for (Int_t i_proj=0;i_proj<n_proj;i_proj++){
            ...
            h_DCA_all[i_energy][i_proj]->SetMarkerColor(marker_res_color[1]);
            h_DCA_primary[i_energy][i_proj]->SetMarkerColor(marker_res_color[2]);
            h_DCA_secondary[i_energy][i_proj]->SetMarkerColor(marker_res_color[0]);
    ...
    for (Int_t i_energy=0;i_energy<n_energy;i_energy++){
        ...
        h_n_hits_after[i_energy]->SetLineColor (marker_res_color[0]);
        h_n_hits_before[i_energy]->SetLineStyle(line_pt_style[1]);
        h_n_hits_after[i_energy]->SetLineStyle (line_pt_style[0]);

        h_mult[i_energy]->SetLineColor(marker_res_color[i_energy+1]);
        for (Int_t i_sort=0;i_sort<n_sorts+1;i_sort++){
            h_pt_reco_before[i_energy][i_sort]->SetLineColor(marker_res_color_selection[i_sort]);
            h_pt_reco_after[i_energy][i_sort]->SetLineColor (marker_res_color_selection[i_sort]);
            h_pt_true_before[i_energy][i_sort]->SetLineColor(marker_res_color_selection[i_sort]);
            h_pt_true_after[i_energy][i_sort]->SetLineColor (marker_res_color_selection[i_sort]);
            ...
            h_pt_reco_before[i_energy][i_sort]->SetLineStyle(line_pt_style[1]);
            h_pt_reco_after[i_energy][i_sort]->SetLineStyle (line_pt_style[0]);
            h_pt_true_before[i_energy][i_sort]->SetLineStyle(line_pt_style[1]);
            h_pt_true_after[i_energy][i_sort]->SetLineStyle (line_pt_style[0]);

            h_eta_reco_before[i_energy][i_sort]->SetLineColor(marker_res_color_selection[i_sort]);
            h_eta_reco_after[i_energy][i_sort]->SetLineColor (marker_res_color_selection[i_sort]);
            h_eta_reco_before[i_energy][i_sort]->SetLineStyle(line_pt_style[1]);
            h_eta_reco_after[i_energy][i_sort]->SetLineStyle (line_pt_style[0]);

            h_pt_eff_before[i_energy][i_sort]->SetLineColor (marker_res_color_selection[i_energy]);
            h_pt_eff_after[i_energy][i_sort]->SetMarkerColor(marker_res_color_selection[i_energy]);
    ...
    for (Int_t i_energy=0;i_energy<n_energy;i_energy++){
        for (Int_t i_harm=0; i_harm<n_harm;i_harm++){
            ...
            p_vn_vs_centrality_true[i_energy][i_harm]->SetMarkerColor(marker_res_color[i_energy+1]);
            p_vn_vs_centrality_reco[i_energy][i_harm]->SetMarkerColor(marker_res_color[i_energy+1]);
            ...
            for (Int_t i_cent=0;i_cent<n_centrality;i_cent++){
                for (Int_t i_sort=0;i_sort<n_sorts;i_sort++){
                    ...
                    p_vn_reco_vs_pt[i_energy][i_harm][i_cent][i_sort]       ->SetMarkerColor(marker_res_color[i_sort+1]);
                    p_vn_reco_vs_rapidity[i_energy][i_harm][i_cent][i_sort] ->SetMarkerColor(marker_res_color[i_sort+1]);
                    p_vn_true_vs_pt[i_energy][i_harm][i_cent][i_sort]       ->SetMarkerColor(marker_res_color[i_sort+1]);
                    p_vn_true_vs_rapidity[i_energy][i_harm][i_cent][i_sort] ->SetMarkerColor(marker_res_color[i_sort+1]);

                    p_vn_reco_vs_pt[i_energy][i_harm][i_cent][i_sort]       ->SetLineColor(marker_res_color[i_sort+1]);
                    p_vn_reco_vs_rapidity[i_energy][i_harm][i_cent][i_sort] ->SetLineColor(marker_res_color[i_sort+1]);
                    p_vn_true_vs_pt[i_energy][i_harm][i_cent][i_sort]       ->SetLineColor(marker_res_color[i_sort+1]);
                    p_vn_true_vs_rapidity[i_energy][i_harm][i_cent][i_sort] ->SetLineColor(marker_res_color[i_sort+1]);
                }
            }
        }
    }
    ...
    TLegend* leg_mult = new TLegend(0.46,0.67,0.85,0.86);
    c_mult->cd();
    c_mult->SetLogy();
    ...
    h_mult[0]->Draw("");
    h_mult[1]->Draw("SAME");
    leg_mult->AddEntry((TObject*)0,"Au+Au, UrQMD","");
    ...
    TLegend* leg_sigm = new TLegend(0.46,0.67,0.85,0.86);
    for (Int_t i_energy=0;i_energy<n_energy;i_energy++){
    ...
    c_b_cent->cd();
    p_resolution_vs_centrality[0]->GetXaxis()->SetNdivisions(505);
    p_resolution_vs_centrality[0]->GetYaxis()->SetNdivisions(505);
    p_resolution_vs_centrality[0]->Draw("P");
    p_resolution_vs_centrality[1]->Draw("P,SAME");
    leg_sigm->AddEntry((TObject*)0,"Au+Au, UrQMD","");
    ...
    leg_eff->AddEntry(h_pt_eff_after[0][2],Form("2#sigma DCA, 5 GeV"),"p");
    //leg_eff->AddEntry(h_pt_eff_after_HP[0][2],Form("motherID,  HITS"),"p");
    leg_eff->AddEntry(h_pt_eff_after[1][2],Form("2#sigma DCA, 11 GeV"),"p");
    ...
    leg_sel->AddEntry((TObject*)0,Form("Au+Au, UrQMD, %s",energy_title[0].Data()),"");
    ...
    h_n_hits_before[0]->SetTitle("");
    h_n_hits_before[0]->GetXaxis()->SetRangeUser(n_hits_range[0],n_hits_range[1]);
    h_n_hits_before[0]->GetYaxis()->SetRangeUser(1.1,2e8);
    ...
    for (int i=0;i<2;i++){
        leg_res_energy[i]->SetHeader("FHCal");
    ...
    leg_cv_cent = new TLegend(0.29,0.24,0.59,0.51);

    leg_cv_cent_energy = new TLegend(0.67,0.69,0.86,0.87);

    c_vn_cent->Divide(2,1);

    leg_cv_cent->AddEntry((TObject*)0,"Au+Au, UrQMD","");
    for (Int_t i_energy=0;i_energy<n_energy;i_energy++){
    ...
    for (Int_t i=0;i<2;i++){
        ...
        p_vn_vs_centrality_true[0][i]->GetXaxis()->SetNdivisions(505);
        if (i==1) p_vn_vs_centrality_true[0][i]->GetYaxis()->SetNdivisions(505);
    ...
    for (Int_t i_energy=0; i_energy<n_energy;i_energy++){
        ...
        //leg_vn_pt[i_energy]->SetHeader(Form("%s",energy_title[i_energy].Data()));
        ...
        c_vn_pt[i_energy]->SaveAs(Form("/home/peter/Documents/WorkLocal/MPD/Pics/Final/c_vn_pt%i.eps",i_energy),"recreate");
        c_vn_pt[i_energy]->SaveAs(Form("/home/peter/Documents/WorkLocal/MPD/Pics/Final/c_vn_pt%i.png",i_energy),"recreate");
        c_vn_pt[i_energy]->SaveAs(Form("/home/peter/Documents/WorkLocal/MPD/Pics/Final/c_vn_pt%i.pdf",i_energy),"recreate");
        c_vn_pt[i_energy]->SaveAs(Form("/home/peter/Documents/WorkLocal/MPD/Pics/Final/c_vn_pt%i.C",i_energy),"recreate");
    }
    ...
    TLegend* leg_vn_rapidity[n_energy][4];
    ...
    for (Int_t i_energy=0; i_energy<n_energy;i_energy++){
      TCanvas* canv_v1 = new TCanvas(Form("canv_v1%i",i_energy),Form("v1 vs rapidity %i", i_energy),500,500);
        ...
        p_vn_reco_vs_rapidity[i_energy][0][0][0]->GetXaxis()->SetNdivisions(505);
        p_vn_reco_vs_rapidity[i_energy][0][0][0]->GetYaxis()->SetNdivisions(505);
        ...
        p_vn_reco_vs_rapidity[i_energy][0][1][0]->GetXaxis()->SetNdivisions(505);
        p_vn_reco_vs_rapidity[i_energy][0][1][0]->GetYaxis()->SetNdivisions(505);
        p_vn_reco_vs_rapidity[i_energy][0][1][0]->Draw();
        leg_vn_type_rapidity[i_energy][1]->Draw();
        leg_vn_rapidity[i_energy][1]->Draw();
        p_vn_reco_vs_rapidity[i_energy][0][1][0]->Draw("SAME");
        ...
        //leg_vn_rapidity[i_energy][2]->SetHeader(Form("%s",energy_title[i_energy].Data()));
        leg_vn_rapidity[i_energy][2]->AddEntry(p_vn_true_vs_rapidity[i_energy][0][0][0],"true","p");
        leg_vn_rapidity[i_energy][2]->AddEntry(p_vn_reco_vs_rapidity[i_energy][0][0][0],"reco","p");
        ...
        p_vn_reco_vs_rapidity[i_energy][1][0][0]->GetXaxis()->SetNdivisions(505);
        p_vn_reco_vs_rapidity[i_energy][1][0][0]->GetYaxis()->SetNdivisions(505);
        p_vn_reco_vs_rapidity[i_energy][1][0][0]->Draw();
        leg_vn_type_rapidity[i_energy][2]->Draw();
        leg_vn_rapidity[i_energy][2]->Draw();
        p_vn_reco_vs_rapidity[i_energy][1][0][0]->Draw("SAME");
        ...
        //leg_vn_rapidity[i_energy][3]->SetHeader(Form("%s",energy_title[i_energy].Data()));
        leg_vn_rapidity[i_energy][3]->AddEntry(p_vn_true_vs_rapidity[i_energy][0][0][0],"true","p");
        leg_vn_rapidity[i_energy][3]->AddEntry(p_vn_reco_vs_rapidity[i_energy][0][0][0],"reco","p");
        ...
        p_vn_reco_vs_rapidity[i_energy][1][1][0]->GetXaxis()->SetNdivisions(505);
        p_vn_reco_vs_rapidity[i_energy][1][1][0]->GetYaxis()->SetNdivisions(505);
        p_vn_reco_vs_rapidity[i_energy][1][1][0]->Draw();
        leg_vn_type_rapidity[i_energy][3]->Draw();
        leg_vn_rapidity[i_energy][3]->Draw();
        p_vn_reco_vs_rapidity[i_energy][1][1][0]->Draw("SAME");
        ...
        c_vn_rapidity[i_energy]->SaveAs(Form("/home/peter/Documents/WorkLocal/MPD/Pics/Final/c_vn_rapidity%i.eps",i_energy),"recreate");
        c_vn_rapidity[i_energy]->SaveAs(Form("/home/peter/Documents/WorkLocal/MPD/Pics/Final/c_vn_rapidity%i.png",i_energy),"recreate");
        c_vn_rapidity[i_energy]->SaveAs(Form("/home/peter/Documents/WorkLocal/MPD/Pics/Final/c_vn_rapidity%i.pdf",i_energy),"recreate");
        c_vn_rapidity[i_energy]->SaveAs(Form("/home/peter/Documents/WorkLocal/MPD/Pics/Final/c_vn_rapidity%i.C",i_energy),"recreate");
    }
