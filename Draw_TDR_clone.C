...
void Draw_TDR_clone()
{
    ...
    in_res_true_file[0] = new TFile("/home/peter/Documents/WorkLocal/MPD/RootFiles/TDR/res_hist-11gev-4M.root","read");
    //in_res_true_file_HP[0] = new TFile("/home/peter/res_hist-11gev.root","read");
    in_res_reco_file[0] = new TFile("/home/peter/Documents/WorkLocal/MPD/RootFiles/TDR/res-fit-11gev-4M.root","read");
    ...
    h_mult[0]->Draw("");
    //h_mult[1]->Draw("SAME");
    leg_mult->SetHeader("Au-Au #sqrt{s_{NN}} = 11 GeV, UrQMD, GEANT3, 4M events","C");
    ...
    leg_sigm->SetHeader("Au-Au #sqrt{s_{NN}} = 11 GeV, UrQMD, GEANT3, 4M events","C");
